...
@HiltViewModel
class NameViewModel @Inject constructor(val regNav : RegisterNavigation) : BaseViewModel() {
    ...
    private fun checkName(text : CharSequence) : Boolean
    {
        ...
        text.forEach {
            if(it.code !in 0xAC00..0xD7AF && it.code !in 0x41..0x5A && it.code !in 0x61..0x7A && it !in "._-")
                return false
